...
namespace CreationMultiplesFeuilles
{
    class App : IExternalApplication
    {
        ...
        public Result OnStartup(UIControlledApplication a)
        {
            ...
            PushButton button = panel.AddItem( new PushButtonData("Création Feuilles", "Créer des feuilles \n à partir de vues", thisAssemblyPath, "CreationMultiplesFeuilles.EntryCommand")) as PushButton;

            button.ToolTip = "Créer des feuilles à partir de vues qui n'ont pas encore été placées";
            Uri uriImage = new Uri("pack://application:,,,/CreationMultiplesFeuilles;component/Resources/favicon.ico");
