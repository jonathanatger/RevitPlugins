...
namespace RenommerDupliquerVues
{
    class App : IExternalApplication
    {
        ...
        public Result OnStartup(UIControlledApplication a)
        {
            ...
            PushButton button = panel.AddItem( new PushButtonData("Renommer et dupliquer des vues", "Renommer et dupliquer \n des vues", thisAssemblyPath, "RenommerDupliquerVues.EntryCommand")) as PushButton;

            button.ToolTip = "Renommer et dupliquer des vues";
            Uri uriImage = new Uri("pack://application:,,,/RenommerDupliquerVues;component/Resources/favicon.ico");
    ...
    public class EventHandlerWithWpfArg : RevitEventWrapper<Ui>
    {
        public override void Execute(UIApplication uiApp, Ui ui)
        {
            ...
            Methods.RenommerDupliquer(ui, doc);
